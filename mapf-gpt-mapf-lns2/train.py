...
while True:
    ...
    # Every DDP rank participates in evaluation collectives; only rank 0 logs/saves.
...
if master_process:
    ...
    torch.save(final_checkpoint, os.path.join(out_dir, "last.pt"))
    logger.info(f"saved final checkpoint to {out_dir}/last.pt")
