...
cp --update=none "$source_root/mapf-gpt-mapf-lns2/runs/mapf_gpt_6m_mapf_lns2/last.pt" \
  "$gpt_dir/mapf_gpt_6m_last_epoch3.pt"
cp --update=none "$source_root/mapf-gpt-mapf-lns2/runs/mapf_gpt_6m_mapf_lns2/ckpt.pt" \
  "$gpt_dir/mapf_gpt_6m_best_epoch3.pt"
cp --update=none "$source_root/mapf-transformer-policy/runs/ablation_map_latent32_one_hop_ctg/last.pt" \
  "$map_dir/map_latent32_1hop_last_epoch3.pt"
cp --update=none "$source_root/mapf-transformer-policy/runs/ablation_map_latent32_one_hop_ctg/best.pt" \
